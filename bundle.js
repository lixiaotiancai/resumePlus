...
var _selfProjectNext = __webpack_require__(/*! ./selfProjectNext */ "./src/component/selfProjectNext/index.js");

var _selfProjectNext2 = _interopRequireDefault(_selfProjectNext);
...
var rootRender = function rootRender(rootId, config) {
  ...
  // 老版本浏览器不支持function.name
  // selfInfo.name = 'selfInfo'
  // selfIntro.name = 'selfIntro'
  // selfExp.name = 'selfExp'
  // selfSkill.name = 'selfSkill'
  // selfProject.name = 'selfProject'

  renderComponent(_selfInfo2.default, _selfIntro2.default, _selfExp2.default, _selfSkill2.default, _selfProjectNext2.default, _selfProject2.default);
...
/***/ "./src/component/selfProjectNext/index.js":
/*!************************************************!*\
  !*** ./src/component/selfProjectNext/index.js ***!
  \************************************************/
/*! no static exports found */
...
var selfProjectNext = function selfProjectNext() {
  return new selfProjectNext.prototype.init();
};

selfProjectNext.prototype.init = function () {
  var section = this.section = (0, _util.createEle)('section');

  section.classList.add('self-project-next');

  return this;
};

selfProjectNext.prototype.template = function (options) {
  var projectTemplate = '';
  ...
  var template = '\n    <div class="project-container">\n      <div class="project-tt-wrapper">\n        <span class="project-tt">Next\u5B66\u4F4D\u4F5C\u54C1</span>\n        <span class="project-tt-en">IMWeb Next Project</span>\n        <div class="project-tt-instruction">"next\u5B66\u4F4D\u4E2D\u5177\u6709\u4EE3\u8868\u6027\u7684\u5C0F\u4F5C\u54C1"</div>\n      </div>\n      <div class="project-main-container">\n        ' + projectTemplate + '\n      </div>\n    </div>';

  this.section.innerHTML = template;
};

selfProjectNext.prototype.bindEvent = function () {};

selfProjectNext.prototype.render = function (options) {
  this.template(options);
  this.bindEvent();
...
selfProjectNext.prototype.init.prototype = selfProjectNext.prototype;

exports.default = selfProjectNext;
...
var config = {
  selfInfo: {
    ...
    firstname: 'Li',
    lastname: 'Xiao',
    avatar: 'resumePlus/images/avatar.jpg',
  ...
  selfSkill: {
    content: [{
      category: 'JavaScript',
      content: 'es6 react nodejs webpack ajax jquery 模块化 cordova等',
      exp: 60,
      degree: '熟悉'
    }, {
      category: 'CSS/HTML',
  ...
  selfProjectNext: {
    content: [{
      ...
      projectName: '响应式简历',
      projectIntro: '响应式的个人简历，通过使用响应式布局，可以同时适应pc端与移动端，也是此简历的雏形。通过完成此项目，对html+css有了一个基本的认识。',
      projectSkillStack: '响应式 flex布局',
      projectCodeLink: 'https://git.imweb.io/f2-t1/RESUME/tree/master',
      projectOnline: 'https://lixiaotiancai.github.io/Resume'
    }, {
      projectName: '基于canvas的射击小游戏',
      projectIntro: '基于canvas与面向对象的思想设计的射击小游戏，并且使用了requestAnimationFrame对游戏元素在页面上的刷新频率进行了优化，从而达到了游戏元素移动平滑的视觉效果。通过完成此项目，对canvas的使用与面向对象的思维有了一个基本的了解。',
      projectSkillStack: 'canvas 面向对象 原型 原型链 继承',
      projectCodeLink: 'https://git.imweb.io/f3-t1/game/tree/master',
      projectOnline: 'https://lixiaotiancai.github.io/beatPlane'
    }, {
      projectName: '口袋豆瓣PWA',
      ...
      projectName: '博客的安全防范实践',
      projectIntro: '对项目中的博客针对xss，csrf，DDOS攻击进行了相关的防范措施，对前端安全防范相关知识有了一定的了解。更重要的是，通过阅读了此项目的前后端源码，让我对整站的设计与架构，前后端的通信有了一个清晰的认识。此项目让我深受启发，让我做出了属于我自己的个人网站。',
      projectSkillStack: '前端安全防范 koa ajax cookie 缓存 前后端交互 整站设计',
      projectCodeLink: 'https://git.imweb.io/f3-t1/security-practice/tree/master',
      projectOnline: 'https://git.imweb.io/f3-t1/security-practice/tree/master'
    }]
  },
  selfProject: {
    content: [{
      ...
      projectIntro: '阅读过imweb团队开源项目badjs-report源码后，深受启发，学到了前端如何将错误信息上报，并借鉴了其设计思想与技巧，造出了自己的线上异常监控工具，支持无后台采用alert的方式将错误报出。',
      projectSkillStack: '前端异常监控 线上异常监控 indexDB 错误信息上报',
